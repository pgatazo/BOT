...
# =============== Config Bot ===============
BOT_NAME = "PauloDamas-GPT — Treinador Virtual"
...
posicoes_lista = ["GR", "Defesa", "Trinco", "Médio", "Extremo", "Avançado"]
...
# =============== UI PRINCIPAL ===============
tab1, tab2 = st.tabs(["⚽ Pré-Jogo", "🔥 Live / 2ª Parte + Treinador GPT"])

# =============== TAB PRÉ-JOGO ===============
with tab1:
    st.header("Análise Pré-Jogo")
    # Formações iniciais + abordagem
    ...
    # Totais de golos/jogos/médias (CASA, FORA, H2H)
...
with tab2:
    st.header("Live/2ª Parte — Previsão de Golos (Modo Escuta + PauloDamas-GPT)")
